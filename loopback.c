...
static void usage(void) { fprintf(stderr, "Usage: loopback <phyical device> <virtual device>\n"); }
...
static struct buse_operations bop = {.read = loopback_read, .write = loopback_write};
